...
public sealed record SecondOrderItemRow : IRow
{
        ...
        new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
            [
                new KeyValuePair<IColumn, ICell>(
                    new ItemIdColumn(),
                    new InvariantCell(
                        new Guid(new System.Guid("0000012e-0000-0000-0000-000000000000"))
                    )
                ),
                new KeyValuePair<IColumn, ICell>(
                ...
                new KeyValuePair<IColumn, ICell>(
                    ...
                    new InvariantCell(
                        new Guid(new System.Guid("00000065-0000-0000-0000-000000000000"))
                    )
                ),
                new KeyValuePair<IColumn, ICell>(
