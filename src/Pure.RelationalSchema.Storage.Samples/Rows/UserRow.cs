...
public sealed record UserRow : IRow
{
        ...
        new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
            [
                ...
                new KeyValuePair<IColumn, ICell>(
                    ...
                    new InvariantCell(
                        new Date(new UShort(15), new UShort(1), new UShort(2020))
                    )
                ),
                new KeyValuePair<IColumn, ICell>(
                ...
                new KeyValuePair<IColumn, ICell>(
                    ...
                    new InvariantCell(
                        new DateTime(
                            ...
                            new Time(new UShort(8), new UShort(30), new UShort(0))
                        )
                    )
                ),
                new KeyValuePair<IColumn, ICell>(
                ...
                new KeyValuePair<IColumn, ICell>(
                    ...
                    new InvariantCell(new MaxDouble())
                ),
                new KeyValuePair<IColumn, ICell>(
                    new UserEdgeDateColumn(),
                    new InvariantCell(
                        new Date(new UShort(29), new UShort(2), new UShort(2024))
                    )
                ),
                new KeyValuePair<IColumn, ICell>(
