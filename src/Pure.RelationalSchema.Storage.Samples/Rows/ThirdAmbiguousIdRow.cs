...
public sealed record ThirdAmbiguousIdRow : IRow
{
    public IReadOnlyDictionary<IColumn, ICell> Cells =>
        new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
            [
                ...
                new KeyValuePair<IColumn, ICell>(
                    new NameColumn(),
                    new InvariantCell(new String("third_entry"))
                ),
                new KeyValuePair<IColumn, ICell>(
                    new CreatedAtColumn(),
                    new InvariantCell(
                        new DateTime(
                            new Date(new UShort(3), new UShort(1), new UShort(2024)),
                            new Time(new UShort(2), new UShort(0), new UShort(0))
                        )
                    )
                ),
            ],
