...
public sealed record FourthProductRow : IRow
{
        ...
        new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
            [
                new KeyValuePair<IColumn, ICell>(
                    new ProductIdColumn(),
                    new InvariantCell(
                        new Guid(new System.Guid("000000cc-0000-0000-0000-000000000000"))
                    )
                ),
                new KeyValuePair<IColumn, ICell>(
                    new ProductNameColumn(),
                    new InvariantCell(new String("Deluxe"))
                ),
                new KeyValuePair<IColumn, ICell>(
                    new ProductDescriptionColumn(),
                    new InvariantCell(new String("Deluxe bundle"))
                ),
                new KeyValuePair<IColumn, ICell>(
