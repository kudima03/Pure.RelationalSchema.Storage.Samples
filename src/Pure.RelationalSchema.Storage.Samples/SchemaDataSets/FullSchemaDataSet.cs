...
public sealed record FullSchemaDataSet : IStoredSchemaDataSet
{
    public ISchema Schema => new FullRelationalSchema();
        ...
        >(
            [
                new KeyValuePair<ITable, IStoredTableDataSet>(
                    new EmptyTable(),
                    new EmptyTableDataSet()
                ),
                new KeyValuePair<ITable, IStoredTableDataSet>(
                    new SingleColumnTable(),
                    new SingleRowTableDataSet()
                ),
                new KeyValuePair<ITable, IStoredTableDataSet>(
                    new TableWithoutIndexes(),
                    new TableWithoutIndexesDataSet()
                ),
                new KeyValuePair<ITable, IStoredTableDataSet>(
                    new TableWithSingleIndex(),
                    new TableWithSingleIndexDataSet()
                ),
                new KeyValuePair<ITable, IStoredTableDataSet>(
                    new TableWithIndexes(),
                    new TableWithIndexesDataSet()
                ),
                new KeyValuePair<ITable, IStoredTableDataSet>(
                    new AllColumnTypesTable(),
                    new AllColumnTypesTableDataSet()
                ),
                new KeyValuePair<ITable, IStoredTableDataSet>(
                    new UsersTable(),
                    new UsersTableDataSet()
                ),
                new KeyValuePair<ITable, IStoredTableDataSet>(
                    new OrdersTable(),
