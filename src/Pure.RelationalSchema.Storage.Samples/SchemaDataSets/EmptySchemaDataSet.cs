...
public sealed record EmptySchemaDataSet : IStoredSchemaDataSet
{
    public ISchema Schema => new EmptyRelationalSchema();
    ...
    private static IReadOnlyDictionary<ITable, IStoredTableDataSet> TablesDataSets =>
        new Dictionary<
            ...
            ITable,
            IStoredTableDataSet
        >([], pair => pair.Key, pair => pair.Value, table => new TableHash(table));
