...
// The audit domain: one relation, whose foreign key points out of the schema
// at schema_with_foreign_keys.users. Pair it with SchemaDataSetWithForeignKeys
// to express a cross-schema join on a uuid key.
public sealed record AuditSchemaDataSet : IStoredSchemaDataSet
{
    public ISchema Schema => new AuditRelationalSchema();
