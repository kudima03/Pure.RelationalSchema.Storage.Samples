...
// Ground-truth mirror of a LoginsTable row, as plain .NET values. A consumer
...
public sealed record LoginRecord(Guid LoginId, Guid LoginUserId, DateTime LoginAt);
