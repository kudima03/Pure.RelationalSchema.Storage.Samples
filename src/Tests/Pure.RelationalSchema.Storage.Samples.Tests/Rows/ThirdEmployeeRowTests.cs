...
public sealed record ThirdEmployeeRowTests
{
    [Fact]
    public void CellsCountIs5()
    {
        IRow row = new ThirdEmployeeRow();
    ...
    public void EmployeeIdCellHoldsExpectedText()
    {
        ...
        Assert.Equal(
            "000002bf-0000-0000-0000-000000000000",
    ...
    public void EmployeeNameCellHoldsExpectedText()
    {
        ...
        Assert.Equal("Iris", row.Cells[new EmployeeNameColumn()].Value.TextValue);
    }
