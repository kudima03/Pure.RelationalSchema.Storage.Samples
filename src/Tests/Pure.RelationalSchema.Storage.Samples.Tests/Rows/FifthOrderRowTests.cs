...
public sealed record FifthOrderRowTests
{
    [Fact]
    public void CellsCountIs7()
    {
        IRow row = new FifthOrderRow();
    ...
    public void OrderTotalCellHoldsExpectedText()
    {
        ...
        Assert.Equal("300", row.Cells[new OrderTotalColumn()].Value.TextValue);
    }
    ...
    public void PlacedOnCellHoldsExpectedText()
    {
        ...
        Assert.Equal("2024-06-05", row.Cells[new PlacedOnColumn()].Value.TextValue);
    }
}
