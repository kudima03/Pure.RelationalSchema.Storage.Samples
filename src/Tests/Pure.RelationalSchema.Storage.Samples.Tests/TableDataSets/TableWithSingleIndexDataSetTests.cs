...
public sealed record TableWithSingleIndexDataSetTests
{
    [Fact]
    public void TableSchemaIsTableWithSingleIndex()
    {
        IStoredTableDataSet dataSet = new TableWithSingleIndexDataSet();
    ...
    [Fact]
    public void ContainsTableWithSingleIndexRow()
    {
        IStoredTableDataSet dataSet = new TableWithSingleIndexDataSet();
        ...
        Assert.Contains(
            ...
            row =>
                new RowHash(row).SequenceEqual(new RowHash(new TableWithSingleIndexRow()))
        );
    }
